...
import com.example.kurikullumwhatsapp.util.*
...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imbtn_profile.setOnClickListener {
            ...
            intent.type = "image/*"
            startActivityForResult(intent, REQUEST_CODE_PHOTO) // setelah memilih gambar
        }
...
// check user yang sedang aktif // jika tidak ada, intent ke Login
